...
public class NhanVienController {
    ...
    @GetMapping("/show")
    public ResponseEntity hienThi(final SearchNhanVienRequest serchNhanVien) {
    ...
    @PostMapping("/add")
    public ResponseEntity add(@RequestBody NhanVienRequest nhanVien, BindingResult result) {
        return new ResponseEntity(service.add(nhanVien, result), HttpStatus.CREATED);
    }

    @PutMapping("/update/{id}")
    public void update(@PathVariable("id") String id, @RequestBody NhanVienRequest nhanVien) {
